  ...
  const renderContent = () => {
    ...
    return (
      <div className="pt-32 pb-20 text-center">
        ...
        <p className="text-slate-600 mb-6">The protocol '{path}' is not recognized.</p>
        ...
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-16">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="space-y-10">
              ...
              {/* DIGITAL PRESENCE — ALIGNED WITH CONTACT PAGE STYLE */}
              <div className="flex items-start space-x-6">
                <div className="w-14 h-14 bg-white/5 rounded-2xl flex items-center justify-center text-indigo-400">
                  <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
                ...
                <div>
                  ...
                  <div className="flex items-center space-x-4">
                    <a
                      ...
                      className="w-10 h-10 rounded-xl bg-white/10 text-white flex items-center justify-center hover:bg-indigo-600 transition-all shadow-lg"
                    >
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
                    </a>

                    <a
                      href="https://www.instagram.com/labelnestindia?igsh=cHA0b2Y2djJheWRk"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-10 h-10 rounded-xl bg-white/10 text-white flex items-center justify-center hover:bg-pink-600 transition-all shadow-lg"
                    >
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-10 h-10 rounded-xl bg-white/10 text-white flex items-center justify-center hover:bg-slate-700 transition-all shadow-lg"
                    >
